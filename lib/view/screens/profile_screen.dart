      ...
      body:
        SafeArea(child: Stack(children: [
          ...
          PositionedWidget(top: 174.h, left: 70.h, width: 50.w, height: 50.h, child: CircleAvatar(
            child: Image.asset('assets/images/profile_screen/profile.png'),
          )),
          PositionedWidget(
              top: 188.h,
              left: 131.w,
              width: 100.w,
              height: 20.h,
              child: CustomText(text: 'Mr Sanju Soni',fontSize: 15.sp,fontWeight: FontWeight.w600,)
          ),
          PositionedWidget(top: 186.h, left: 282.w, width: 30.w, height:30.h, child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(50.r),color: Color(0xffD9D9D9)),
              ...
              child:Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.r),color: Color(0xffffffff),boxShadow: [BoxShadow(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      ...
                      CustomListTile(imagePath: 'assets/images/profile_screen/leading_icon/2.png',title: 'My bookings',),
